...
image::day3/screenshots/install.png[Select _Help/Install New Software..._]
...
image::day3/screenshots/install2.png[Install window]
...
image::day3/screenshots/query_explorer.png[Query Explorer]
